...
const projects = [
  {
    ...
    description: "A cross-platform user interface for Android Debug Bridge (ADB), making Android device management easier",
  ...
  },
  {
    ...
    description: "A modern Android app built with Jetpack Compose for conference management",
  ...
  },
  {
    ...
    description: "A web application for analyzing and visualizing GPS data in vehicle networks",
